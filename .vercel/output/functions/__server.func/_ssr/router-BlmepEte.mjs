...
//#region node_modules/.nitro/vite/services/ssr/assets/router-BlmepEte.js
...
var styles_default = "/assets/styles-BbHfU49f.css";
var APP_NAME = "株式会社コスギ";
var Route$3 = createRootRoute({
	head: () => ({
		meta: [
			...
			{ title: `${APP_NAME}｜ユニフォーム専門店` },
			{
				name: "description",
				content: "株式会社コスギは秋田・庄内エリアを中心に、作業服・事務服・白衣などワーキングウェアを提案するユニフォーム専門店です。"
			},
			{
				name: "theme-color",
				content: "#002559"
...
var $$splitComponentImporter$2 = () => import("./routes-CfPrzY17.mjs");
var Route$2 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$2, "component") });
var $$splitComponentImporter$1 = () => import("./contact-CAvNVrcG.mjs");
var Route$1 = createFileRoute("/contact")({
	...
	head: () => ({ meta: [{ title: "お問い合わせ｜株式会社コスギ" }] })
});
var $$splitComponentImporter = () => import("./privacy-BqIfYuiM.mjs");
var Route = createFileRoute("/privacy")({
	component: lazyRouteComponent($$splitComponentImporter, "component"),
	head: () => ({ meta: [{ title: "プライバシーポリシー｜株式会社コスギ" }] })
});
